...
write.table(a.ids,file=paste0("inds_",fname,".txt"),row.names=F,col.names=F)
...
write.table(a.mean.gl, file="pntest_mean_gl.txt", row.names=F, col.names=F, quote=F, sep=" ")
